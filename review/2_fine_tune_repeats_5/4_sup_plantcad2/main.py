...
def train(
    ...
    task_type : str, optional
        Type of task: "classification" or "regression", by default "classification"
    ...
    """
    logger.info(f"Loading base model from {model_name}")
    model = load_base_model(model_name, task_type)
...
def load_base_model(model_name: str, task_type: str) -> AutoModelForSequenceClassification:
    if task_type == 'classification':
