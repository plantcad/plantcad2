...
#SBATCH -J pcv2-l24-d0768-4k-seed123
...
export OUTPUT_DIR="${DATA_DIR}/pcv2-l24-d0768-4k-checkpoints-lr-1e-4-seed123"
...
if [ "$MODE" == "train" ]; then
    ...
    torchrun \
        ...
        --wandb_run_name "exp-leaf-abs_pcv2-l24-d0768-4k-seed123" \
        --learning_rate 1e-4 \
        --warmup_steps 50 \
