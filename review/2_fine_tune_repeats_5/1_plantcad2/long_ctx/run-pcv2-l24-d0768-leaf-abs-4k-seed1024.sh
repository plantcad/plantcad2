...
#SBATCH -J pcv2-l24-d0768-4k-seed1024
...
export TRITON_CACHE_DIR=/scratch/10373/jzhai/tmp/triton
export XDG_CACHE_HOME=/scratch/10373/jzhai/tmp/xdg
export TRITON_AUTOTUNE_CACHE_DIR=$TRITON_CACHE_DIR

# Environment variables
export TRITON_PTXAS_PATH=/opt/apps/cuda/12.4/bin/ptxas

export DATA_DIR=${cad2}/results/PlantCAD2_tasks/exp-leaf-abs
export OUTPUT_DIR="${DATA_DIR}/pcv2-l24-d0768-4k-checkpoints-lr-1e-4-seed1024"
...
if [ "$MODE" == "train" ]; then
    ...
    torchrun \
        ...
        ../dev.py train \
        --train_dir=$DATA_DIR/train_4k.parquet \
        --valid_dir=$DATA_DIR/valid_4k.parquet \
        ...
        --wandb_run_name "exp-leaf-abs_pcv2-l24-d0768-4k-seed1024" \
        --learning_rate 1e-4 \
        --warmup_steps 50 \
