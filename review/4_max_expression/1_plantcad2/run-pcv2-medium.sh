...
export DATA_DIR=${cad2}/results/PlantCAD2_tasks/exp-max
export OUTPUT_DIR="${DATA_DIR}/pcv2-l48-d1024-checkpoints-lr-1e-4"
...
if [ "$MODE" == "train" ]; then
    ...
    torchrun \
        ...
        --wandb_run_name "exp-max_pcv2-l48-d1024" \
        --learning_rate 1e-4 \
        --warmup_steps 50 \
