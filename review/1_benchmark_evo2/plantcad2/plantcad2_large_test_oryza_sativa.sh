...
TEST_EMBEDDINGS=${OUTPUT_DIR}/test_oryza_sativa_large.pkl

# evaluate xgboost
python plantcad2.py evaluate \
    --test-embeddings ${TEST_EMBEDDINGS} \
    --model ${OUTPUT_DIR}/xgb_plantcad2_large_mean.pkl \
    --output ${OUTPUT_DIR}/xgb_plantcad2_large_mean_oryza_sativa_results.tsv

python plantcad2.py evaluate \
    --test-embeddings ${TEST_EMBEDDINGS} \
    --model ${OUTPUT_DIR}/xgb_plantcad2_large_max.pkl \
    --output ${OUTPUT_DIR}/xgb_plantcad2_large_max_oryza_sativa_results.tsv

# evaluate neural network
python plantcad2.py evaluate \
    --test-embeddings ${TEST_EMBEDDINGS} \
    --model ${OUTPUT_DIR}/nn_plantcad2_large_mean.pkl \
    --output ${OUTPUT_DIR}/nn_plantcad2_large_mean_oryza_sativa_results.tsv

python plantcad2.py evaluate \
    --test-embeddings ${TEST_EMBEDDINGS} \
    --model ${OUTPUT_DIR}/nn_plantcad2_large_max.pkl \
    --output ${OUTPUT_DIR}/nn_plantcad2_large_max_oryza_sativa_results.tsv
