...
TEST_EMBEDDINGS=${OUTPUT_DIR}/test_glycine_max_medium.pkl

# evaluate xgboost
python plantcad2.py evaluate \
    --test-embeddings ${TEST_EMBEDDINGS} \
    --model ${OUTPUT_DIR}/xgb_plantcad2_medium_mean.pkl \
    --output ${OUTPUT_DIR}/xgb_plantcad2_medium_mean_glycine_max_results.tsv

python plantcad2.py evaluate \
    --test-embeddings ${TEST_EMBEDDINGS} \
    --model ${OUTPUT_DIR}/xgb_plantcad2_medium_max.pkl \
    --output ${OUTPUT_DIR}/xgb_plantcad2_medium_max_glycine_max_results.tsv

# evaluate neural network
python plantcad2.py evaluate \
    --test-embeddings ${TEST_EMBEDDINGS} \
    --model ${OUTPUT_DIR}/nn_plantcad2_medium_mean.pkl \
    --output ${OUTPUT_DIR}/nn_plantcad2_medium_mean_glycine_max_results.tsv

python plantcad2.py evaluate \
    --test-embeddings ${TEST_EMBEDDINGS} \
    --model ${OUTPUT_DIR}/nn_plantcad2_medium_max.pkl \
    --output ${OUTPUT_DIR}/nn_plantcad2_medium_max_glycine_max_results.tsv
