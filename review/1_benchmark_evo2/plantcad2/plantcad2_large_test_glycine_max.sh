...
TEST_EMBEDDINGS=${OUTPUT_DIR}/test_glycine_max_large.pkl

# evaluate xgboost
python plantcad2.py evaluate \
    --test-embeddings ${TEST_EMBEDDINGS} \
    --model ${OUTPUT_DIR}/xgb_plantcad2_large_mean.pkl \
    --output ${OUTPUT_DIR}/xgb_plantcad2_large_mean_glycine_max_results.tsv

python plantcad2.py evaluate \
    --test-embeddings ${TEST_EMBEDDINGS} \
    --model ${OUTPUT_DIR}/xgb_plantcad2_large_max.pkl \
    --output ${OUTPUT_DIR}/xgb_plantcad2_large_max_glycine_max_results.tsv

# evaluate neural network
python plantcad2.py evaluate \
    --test-embeddings ${TEST_EMBEDDINGS} \
    --model ${OUTPUT_DIR}/nn_plantcad2_large_mean.pkl \
    --output ${OUTPUT_DIR}/nn_plantcad2_large_mean_glycine_max_results.tsv

python plantcad2.py evaluate \
    --test-embeddings ${TEST_EMBEDDINGS} \
    --model ${OUTPUT_DIR}/nn_plantcad2_large_max.pkl \
    --output ${OUTPUT_DIR}/nn_plantcad2_large_max_glycine_max_results.tsv
