...
TEST_EMBEDDINGS=${OUTPUT_DIR}/test_zea_mays_small.pkl

# evaluate xgboost
python plantcad2.py evaluate \
    --test-embeddings ${TEST_EMBEDDINGS} \
    --model ${OUTPUT_DIR}/xgb_plantcad2_small_mean.pkl \
    --output ${OUTPUT_DIR}/xgb_plantcad2_small_mean_zea_mays_results.tsv

python plantcad2.py evaluate \
    --test-embeddings ${TEST_EMBEDDINGS} \
    --model ${OUTPUT_DIR}/xgb_plantcad2_small_max.pkl \
    --output ${OUTPUT_DIR}/xgb_plantcad2_small_max_zea_mays_results.tsv

# evaluate neural network
python plantcad2.py evaluate \
    --test-embeddings ${TEST_EMBEDDINGS} \
    --model ${OUTPUT_DIR}/nn_plantcad2_small_mean.pkl \
    --output ${OUTPUT_DIR}/nn_plantcad2_small_mean_zea_mays_results.tsv

python plantcad2.py evaluate \
    --test-embeddings ${TEST_EMBEDDINGS} \
    --model ${OUTPUT_DIR}/nn_plantcad2_small_max.pkl \
    --output ${OUTPUT_DIR}/nn_plantcad2_small_max_zea_mays_results.tsv
