DATA_DIR=/local/workdir/jz963/utils/plantcad2/results/PlantCAD2_tasks/maize_cell_type_accessible_c300
...
CUDA_VISIBLE_DEVICES=1 python main.py train  \
    ...
    --output_dir ${CKPT_DIR} \
    --run_id maize_cell_type_accessible_c300_cnn-lstm-imbalance-lr-1e-3 \
    --learning_rate 0.001 \
