...
export DATA_DIR=/work/10373/jzhai/vista/utils/plantcad2/results/PlantCAD2_tasks/maize_cell_type_accessible_c600
...
if [ "$MODE" == "train" ]; then
    ...
    torchrun \
        ...
        --wandb_run_name "maize_cell_type_accessible_c600_pcv2-l24-d0768" \
        --learning_rate 1e-4 \
        --warmup_steps 50 \
