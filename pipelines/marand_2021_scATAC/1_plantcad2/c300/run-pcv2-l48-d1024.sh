...
if [ "$MODE" == "train" ]; then
    ...
    torchrun \
        ...
        --wandb_run_name "maize_cell_type_accessible_c300_pcv2-l48-d1024" \
        --learning_rate 1e-4 \
        --warmup_steps 50 \
