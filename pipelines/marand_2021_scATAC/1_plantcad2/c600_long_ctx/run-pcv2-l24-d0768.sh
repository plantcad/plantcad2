...
export DATA_DIR=${CAD2}/results/PlantCAD2_tasks/maize_cell_type_accessible_c600
export OUTPUT_DIR="${DATA_DIR}/pcv2-l24-d0768-flank-500-checkpoints-lr-1e-4"
...
if [ "$MODE" == "train" ]; then
    ...
    torchrun \
        ...
        ../main.py train \
        --train_dir=$DATA_DIR/train_flank_500.parquet \
        --valid_dir=$DATA_DIR/valid_flank_500.parquet \
        ...
        --wandb_run_name "maize_cell_type_accessible_c600_pcv2-l24-d0768_flank_500" \
        --learning_rate 1e-4 \
        --warmup_steps 50 \
