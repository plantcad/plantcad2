...
export DATA_DIR=/work/10373/jzhai/vista/utils/plantcad2/results/PlantCAD2_tasks/maize_cell_type_accessible_c1000
...
if [ "$MODE" == "train" ]; then
    ...
    torchrun \
        ...
        --wandb_run_name "maize_cell_type_accessible_c1000_pcv2-l48-d1024" \
        --learning_rate 1e-4 \
        --warmup_steps 50 \
