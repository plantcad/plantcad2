DATA_DIR=/local/workdir/jz963/utils/plantcad2/results/PlantCAD2_tasks/accessible_angiosperm_c300
CKPT_DIR=${DATA_DIR}/cnn-lstm-imbalance-lr-1e-3
python main.py train  \
    --train $DATA_DIR/train.tsv \
    --valid $DATA_DIR/valid.tsv \
    --output_dir ${CKPT_DIR} \
    --run_id accessible_angiosperm_c300_cnn-lstm-imbalance-lr-1e-3 \
    --learning_rate 0.001 \
...
python main.py train  \
    ...
    --valid $DATA_DIR/valid.tsv \
    --output_dir ${CKPT_DIR} \
    --run_id accessible_angiosperm_c300_cnn-lstm-balance-lr-1e-3 \
    --learning_rate 0.001 \
    --wandb_project PlantCAD2 \
    --balance True
