...
PCV2_1_PATHS = {
    "start_sites": f"{TAXA}_tis_mask_ATG_pcv2-l24-d0768.h5",
    "stop_sites": f"{TAXA}_stop_sites_mask_TAG_pcv2-l24-d0768.h5", 
    "donor": f"{TAXA}_donor_mask_GT_pcv2-l24-d0768.h5",
    "acceptor": f"{TAXA}_acceptor_mask_AG_pcv2-l24-d0768.h5"
}

PCV2_2_PATHS = {
    "start_sites": f"{TAXA}_tis_mask_ATG_pcv2-l48-d1024.h5",
    "stop_sites": f"{TAXA}_stop_sites_mask_TAG_pcv2-l48-d1024.h5", 
    "donor": f"{TAXA}_donor_mask_GT_pcv2-l48-d1024.h5",
    "acceptor": f"{TAXA}_acceptor_mask_AG_pcv2-l48-d1024.h5"
}

PCV2_3_PATHS = {
    "start_sites": f"{TAXA}_tis_mask_ATG_pcv2-l48-d1536.h5",
    "stop_sites": f"{TAXA}_stop_sites_mask_TAG_pcv2-l48-d1536.h5", 
    "donor": f"{TAXA}_donor_mask_GT_pcv2-l48-d1536.h5",
    "acceptor": f"{TAXA}_acceptor_mask_AG_pcv2-l48-d1536.h5"
}
...
LABEL_PATHS = {
    "start_sites": f"{TAXA}_filtered_tis_labels.tsv",
    "stop_sites": f"{TAXA}_filtered_tss_labels.tsv",
    "donor": f"{TAXA}_filtered_donor_labels.tsv",
    "acceptor": f"{TAXA}_filtered_acceptor_labels.tsv"
}
