...
#     --length 4094 \
#     --output ${OUTPUT}${TAXA}_start_sites_evo2_7b_ntokens_3 \
...
#     --length 4094 \
#     --output ${OUTPUT}${TAXA}_stop_sites_evo2_7b_ntokens_3 \
#     --batch-size 2 --n-tokens 3
...
#     --length 4095 \
#     --output ${OUTPUT}${TAXA}_donor_filtered_evo2_7b_ntokens_2 \
...
CUDA_VISIBLE_DEVICES=1 python ../../pseudo_gene_maize/2_evo2/evo2_generate.py \
    ...
    --length 4095 \
    --output ${OUTPUT}${TAXA}_acceptor_filtered_evo2_7b_ntokens_2 \
    --batch-size 2 --n-tokens 2
...
CUDA_VISIBLE_DEVICES=0 python ../../pseudo_gene_maize/2_evo2/evo2_generate.py \
    --fasta ${DATA_DIR}${TAXA}_donor_sites_filtered_rmless8192.fasta \
    --length 4095 \
