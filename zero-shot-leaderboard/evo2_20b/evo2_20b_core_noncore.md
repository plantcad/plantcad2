...
| **tis_core_noncore_classification** | test_maize | 0.686 | 0.875 | rc |
|  | test_tomato | 0.644 | 0.905 | rc |
...
| tis_core_noncore_classification | test_maize | left | 0.410 | 0.712 |
| tis_core_noncore_classification | test_maize | right_reverse_complement | 0.686 | 0.875 |
