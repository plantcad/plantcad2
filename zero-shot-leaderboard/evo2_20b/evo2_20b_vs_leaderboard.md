# evo2_20b vs PlantCAD2 zero-shot leaderboard

evo2_20b is an external model evaluated here with our causal harness; PlantCAD2.5-L and the other leaderboard columns are the published numbers.
...
| tis | maize | 0.624 | 0.696 | 0.743 | 0.686 | rc | +0.057 |
