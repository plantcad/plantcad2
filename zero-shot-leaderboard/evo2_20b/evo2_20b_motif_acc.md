...
|  | test_tomato | 0.842 | 0.785 | rc |
| **donor_recovery** | test_maize | 0.877 | 0.822 | fwd |
|  | test_tomato | 0.851 | 0.789 | fwd |
...
| acceptor_recovery | test_tomato | right_reverse_complement | 0.842 | 0.785 |
| donor_recovery | test_maize | left | 0.877 | 0.822 |
| donor_recovery | test_maize | right_reverse_complement | 0.581 | 0.357 |
| donor_recovery | test_tomato | left | 0.851 | 0.789 |
| donor_recovery | test_tomato | right_reverse_complement | 0.556 | 0.337 |
